...
(function($) {
	...
	var handlers = {
		...
		onUploadSuccess : function(file, data, response) {
			...
			if ($.inArray('onUploadSuccess', settings.overrideEvents) < 0) {
				if(data){
					...
					if(jsondata && jsondata.error=='0'){
							$('#' + file.id).find('.data').html(" <font color='green'>上传完毕</font>");
							response =true;
							returndata = jsondata.url;
					}else{
			...
			// Call the user-defined event handler
			if (settings.onUploadSuccess) settings.onUploadSuccess.call(this, file, returndata, response); 
		}
